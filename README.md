...
You may find it at https://gitlab.cern.ch/WisconsinCMS/APx-SW/peekpoke
...
git remote set-url origin ssh://git@gitlab.cern.ch:7999/WisconsinCMS/APx-SW/peekpoke.git
```
...
```sh
git remote set-url origin https://gitlab.cern.ch/WisconsinCMS/APx-SW/peekpoke.git
```
